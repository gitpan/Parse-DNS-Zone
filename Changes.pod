...
=head2 0.41 (2011-01-07)

=item * Origin is now appended in RDATA (thanks to Sebastian 
Hagedorn at Universität zu Köln).

=item * Some minor documentation fixes

=head2 0.4 (2010-11-21)

=over

=item * get_rdata returns a list of complete RRset in list context.
B<Please be aware that this may break existing code.> Sorry :-(

=item * Fixes to documentation (new mail address, <olof@cpan.org>)
